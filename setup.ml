...
(* OASIS_START *)
(* DO NOT EDIT (digest: 72650ca4d7647b8fbf59efd0b173f343) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("lambda-term-api", OCamlbuildDocPlugin.doc_build "./")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("lambda-term-api", OCamlbuildDocPlugin.doc_clean "./")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          synopsis = "Lambda-Term";
          description =
            Some "Corss-platform library for terminal manipulation";
          categories = [];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Darcs;
                      src_repo_location =
                        "http://darcs.ocamlcore.org/repos/lambda-term";
                      src_repo_browser =
                        Some
                          "http://darcs.ocamlcore.org/cgi-bin/darcsweb.cgi?r=lambda-term;a=summary";
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("icu.io", None);
                           FindlibPackage ("icu.syntax", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["lt_windows_stubs.c"];
                      bs_data_files = [];
